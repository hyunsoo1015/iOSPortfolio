...
class ClassificationViewController: UIViewController {
    ...
    func filterContentForSearchText(_ searchText: String, scope: String = "All") {
        ...
        //map-reduce: 데이터가 존재하는 곳에서 연산을 수행하고
        //그 결과를 합쳐서 최종 결과를 만들어내는 방식
        
        //엣지 컴퓨팅: 데이터 발생지에서 무엇인가를 하자
    }
    ...
    override func viewDidLoad() {
        ...
        //기본 데이터 생성
        data = ["이운재", "손흥민", "기성용", "조원희", "박지성", "차범근", "이영표", "홍명보", "안정환", "김태영", "김남일", "이천수", "박주영", "이호", "김동진", "이강인", "차두리", "정성룡", "황의조", "백승호"]
        ...
        //각각의 배열을 인덱스와 묶어서 Dictionary 를 만들고
        //이 딕셔너리를 분류 배열에 저장
        i = 0
...
extension ClassificationViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        //Objective-C 의 자료형으로 변환한 후 다시 변환
        //Objective-C 의 자료형은 swift 자료형 앞에 NS를 추가
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //섹션으로 딕셔너리를 찾고 딕셔너리 안의 배열에서
        //행 번호를 이용해서 출력할 데이터를 찾아와야 한다.
